...
static void print_de(int, struct frame*, int *split);
...
static char* get_attr_id_name(int attr_id)
{
	int i;
...
static uint8_t parse_de_hdr(struct frame *frm, int* n)
{
...
static void print_int(uint8_t de_type, int level, int n, struct frame *frm)
{
	uint64_t val, val2;
...
static void print_string(int n, struct frame *frm, const char *name)
{
	printf(" %s \"%*.*s\"", name, n, n, (char *) frm->ptr);
	frm->ptr += n;
	frm->len -= n;
}

static void print_des(uint8_t de_type, int level, int n, struct frame *frm, int *split)
{
	int len = frm->len;
	while (len - frm->len < n )
...
static void print_de(int level, struct frame *frm, int *split)
{
	int  n;
...
static void print_srv_srch_pat(int level, struct frame *frm)
{
	int len = frm->len;
	int n1;
	int n2;
...
static void print_attr_id_list(int level, struct frame *frm)
{
	uint16_t attr_id;
...
static void print_attr_list(int level, struct frame *frm)
{
	uint16_t attr_id;
	int   n1, n2, split;
	int   len = frm->len;
...
static void print_attr_lists(int level, struct frame *frm, int len)
{
	int   n;
	int   cnt = 0;
...
static void err_rsp(int level, uint16_t tid, uint16_t len, struct frame *frm)
{
...
static void ss_req(int level, uint16_t tid, uint16_t len, struct frame *frm)
{
...
static void ss_rsp(int level, uint16_t tid, uint16_t len, struct frame *frm)
{
	register int i;
...
static void sa_req(int level, uint16_t tid, uint16_t len, struct frame *frm)
{
...
static void sa_rsp(int level, uint16_t tid, uint16_t len, struct frame *frm)
{
...
static void ssa_req(int level, uint16_t tid, uint16_t len, struct frame *frm)
{
...
static void ssa_rsp(int level, uint16_t tid, uint16_t len, struct frame *frm)
{
	int cnt;
